...
can access all of the data in the usual format `r output$data`, which in of itself 
will return another list of objects, 7 to be specific. Lets go through them all.

### data

The data element accessed by `r output$data$data` is the original data with a few
